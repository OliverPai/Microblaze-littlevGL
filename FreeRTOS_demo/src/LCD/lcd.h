...
//输入参数定义
#define READ   0		//slv_reg2
#define WRITE  1
#define REG    0		//slv_reg
#define DATA   1
#define START  1		//slv_reg1
#define RESET  0		//slv_reg0
...
void LCD_ShowChar(u16 x,u16 y,u8 num, u16 COLOR,u8 mode);						//显示一个字符
void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u16 COLOR,u8 mode);  						//显示一个数字
void LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 mode ,u16 COLOR);				//显示 数字
void LCD_ShowString(u16 x,u16 y,char *p, u16 COLOR,u8 mode);						//显示一个字符串,24字体
